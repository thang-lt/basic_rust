...
fn main() {
    ...
    let mut school1: School = School::new();
    school1.add(5, "Alice".to_string());
    school1.add(10, "WIN".to_string());
    school1.add(4, "Ws".to_string());
    school1.add(4, "Ks".to_string());
    

    // let students = &school1.get_students();
    // println!("students: {:?}", students);

    // let grades = school1.grades();
    // println!("grades: {:?}", grades);

    let grade = school1.grade(4);
    println!("grade: {:?}", grade);
...
impl School {
    ...
    pub fn add(&mut self, grade: u32, student: String) {
        self.students.insert(student.parse().unwrap(), grade);
    }

    pub fn get_students(self) -> HashMap<String, u32>{
        return self.students;
    }

    pub fn frind_grades_by_name(&self, student: String) {
        let a = self.students.get(&student.to_string());
    }
    ...
    pub fn grade(&self, grade: u32) -> Vec<String> {
        ...
        for (student, gr) in &self.students {
            if *gr == grade {
